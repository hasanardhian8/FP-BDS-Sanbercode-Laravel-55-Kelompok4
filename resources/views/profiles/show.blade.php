...
<div class="container mt-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="first_name" class="form-control" value="{{ $profile->first_name }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="last_name" class="form-label">Last Name</label>
                        <input type="text" id="last_name" class="form-control" value="{{ $profile->last_name }}" readonly>
                    </div>
                    <div class="mb-3">
    ...
    <form action="{{ route('profile.edit', ['id' => auth()->id()]) }}" method="GET" class="d-inline">
        @csrf
